    ...
    try {
        ...
        if (cliMajor !== serverMajor) {
            ...
            console.error(
                `${styles.title(
                    'Warning',
                )}: CLI v${CLI_VERSION} may be incompatible with Lightdash v${health.version} on ${
                    config.context?.serverUrl
                }.\n         Major version mismatch (${cliMajor} vs ${serverMajor}). Some commands may fail.\n         Upgrade your CLI: ${styles.secondary(
