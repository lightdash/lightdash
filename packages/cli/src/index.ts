...
program
    ...
    .description(
        'Login to a Lightdash instance.\n\n👀 See https://docs.lightdash.com/guides/cli/how-to-install-the-lightdash-cli#authentication for more help and examples',
    )
    .addHelpText(
        'after',
        `
...
const errorHandler = (err: Error) => {
    ...
    if (err.name === 'AuthorizationError') {
        console.error(
            `Looks like you did not authenticate or the personal access token expired.\n\n👀 See https://docs.lightdash.com/guides/cli/how-to-install-the-lightdash-cli#authentication for help and examples`,
        );
