...
const LargeExportWarning: FC<LargeExportWarningProps> = ({
    ...
    return (
        ...
        >
            This export is about {cellMillions} million cells.
            {exportTimeoutMinutes !== null &&
                ` Exports that take longer than ${exportTimeoutMinutes} minutes fail.`}{' '}
            Filter the results or use a scheduled delivery to Google Sheets.
        </Callout>
    );
};
