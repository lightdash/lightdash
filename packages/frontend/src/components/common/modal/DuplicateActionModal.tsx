...
type DupplicateActionModalProps<T> = {
...
const DupplicateActionModal = <T extends { uuid: string; name: string }>(
    props: DupplicateActionModalProps<T>,
) => {
...
DupplicateActionModal.defaultProps = {
    savedData: {},
    onClose: () => {},
    setFormValues: () => {},
};

export default DupplicateActionModal;
