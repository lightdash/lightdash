...
import { createFieldSuggestionMatch } from './findFieldSuggestionMatch';
...
export const generateFieldSuggestion = (
    ...
    const sortedFields = sortFieldSuggestions(fields);
    return {
        ...generateSuggestion({
            items: sortedFields,
        ...
        allowSpaces: true,
        findSuggestionMatch: createFieldSuggestionMatch(
