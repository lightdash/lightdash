...
// ---------------------------------------------------------------------------
// AuditUser — extends SpaceShare with origin info for the "Who has access" tab
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// UserAccessAuditList — read-only flat list with origin + role badges
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Main modal — Option A: Manage / Who has access
// ---------------------------------------------------------------------------
...
const ShareSpaceModalV2A: FC<ShareSpaceProps> = ({ space, projectUuid }) => {
    ...
    // Audit list — flat list of ALL users with origin info
