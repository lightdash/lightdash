...
// --- Inheritance model types (used by V2A modal) ---
...
export const NestedInheritanceOptions: AccessOption[] = [
    {
        title: 'Inherit parent access',
        description: 'Users with access to parent spaces also have access here',
        selectDescription:
