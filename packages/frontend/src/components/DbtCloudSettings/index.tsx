...
const DbtCloudSettings: FC<DbtCloudSettingsProps> = () => {
        ...
        <form onSubmit={form.onSubmit(handleSubmit)}>
            ...
            <SettingsGridCard>
                <Stack spacing="sm">
                    ...
                    <Text color="dimmed">
                        dbt Semantic Layer is available now in Lightdash Cloud.
                        To get setup, reach out to your Lightdash support rep or
                        email support@lightdash.com to have this activated in
                        your account.
                    </Text>
                    <Text color="dimmed">
