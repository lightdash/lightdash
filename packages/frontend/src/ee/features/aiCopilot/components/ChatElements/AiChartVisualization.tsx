...
export const AiChartVisualization: FC<Props> = ({
    ...
    const chartOptions = getChartOptionsFromAiAgentThreadMessageVizQuery({
        config: vizConfig,
        rows: results.rows,
        type,
    });
    const chartConfig = getAiAgentChartConfig({
        type: type,
        chartOptions,
        metricQuery,
    });
            ...
            >
                <VisualizationProvider
                    ...
                    pivotTableMaxColumnLimit={
                        health?.pivotTable.maxColumnLimit ?? 60 // TODO :: do we have a default?
                    }
