...
export const AgentChatInput = ({
    ...
    // Minimal mode: simple inline input for existing threads
    if (isMinimalMode) {
        return (
            <Box className={styles.minimalContainer}>
                {/* Warning banner for long threads */}
                {showWarningBanner && (
                    <Paper
                        className={styles.minimalWarningBanner}
                        px="md"
                        py="xs"
                    >
    ...
    // Full mode: card with model selector for new threads
    return (
        <Box
        ...
        >
            {/* Warning banner for long threads */}
            {showWarningBanner && (
                <Paper className={styles.warningBanner} px="md" py="xs">
                    <Text size="xs" c="dimmed" ta="center">
                        Agent performance degrades if a thread is too long.
                        Please start a{' '}
                        <Anchor
