...
export const simpleSeriesMapArgs: GetExpectedSeriesMapArgs = {
    ...
    resultsData: {
        ...
        rows: [
            {
                dimension_x: { raw: 'a', formatted: 'a' },
                my_dimension: { raw: 'a', formatted: 'a' },
                my_metric: { raw: 'a', formatted: 'a' },
                my_second_metric: { raw: 'a', formatted: 'a' },
            },
            {
                dimension_x: { raw: 'b', formatted: 'b' },
                my_dimension: { raw: 'a', formatted: 'a' },
                my_metric: { raw: 'a', formatted: 'a' },
                my_second_metric: { raw: 'a', formatted: 'a' },
            },
...
export const multiPivotSeriesMapArgs: GetExpectedSeriesMapArgs = {
    ...
    resultsData: {
        ...
        rows: [
            {
                dimension_x: { raw: 'a', formatted: 'a' },
                dimension_y: { raw: 'a', formatted: 'a' },
                my_dimension: { raw: 'a', formatted: 'a' },
                my_metric: { raw: 'a', formatted: 'a' },
            },
            {
                dimension_x: { raw: 'b', formatted: 'b' },
                dimension_y: { raw: 'b', formatted: 'b' },
                my_dimension: { raw: 'a', formatted: 'a' },
                my_metric: { raw: 'a', formatted: 'a' },
            },
            {
