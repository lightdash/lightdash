...
import { type TableIdentity } from '../utils/tableRows';
...
/**
 * Shown when a table click would move the runner to another connection while
 * the editor holds SQL the user wrote. Nothing changes until they confirm.
 */
