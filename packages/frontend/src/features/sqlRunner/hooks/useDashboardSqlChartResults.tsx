...
import { getDashboardSqlChartResults } from './useSqlChartResults';

export const useDashboardSqlChartResults = ({
    dashboardUuid,
    savedSqlUuid,
    slug,
    projectUuid,
    ...
    >(
        ...
        async () => {
            ...
            const chartResults = await getDashboardSqlChartResults(
                projectUuid!,
                {
