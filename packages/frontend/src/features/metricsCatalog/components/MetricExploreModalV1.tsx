...
/**
 * V1: Original MetricExploreModal implementation using recharts
 * This is the fallback when the feature flag is disabled
 */
export const MetricExploreModalV1: FC<Props> = ({
    opened,
    onClose,
    metrics,
}) => {
