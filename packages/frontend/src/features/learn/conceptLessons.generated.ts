...
export const CONCEPT_LESSONS: Record<string, ConceptLesson> = {
        ...
        sections: [
            {
                ...
                sourceHash:
                    '878aca4f33fa67f3a4907d5ebdb475d9fb7ffb5144a1913d89610aadfa36ad58',
            },
        ],
    },
        ...
        sections: [
            {
                ...
                sourceHash:
                    'fdb2a7c61be95d9dadcfb4baf4381cb62630a4356e9d6f95bc1c6dcf398041fa',
            },
            {
                heading: 'Limitations',
    ...
    'view:SpotlightTableConfig': {
        ...
        sections: [
            {
                heading: 'The spotlight config',
                body: "`spotlight` is the YAML namespace that covers everything about how your metrics show up across the Metrics experience — visibility in the catalog (`visibility`), grouping (`categories`), ownership (`owner`), and explorer behavior like default time dimensions, filters, and segments. It works at two levels:\n\n- **Project level** — defaults for the whole project, set in [`lightdash.config.yml`](https://docs.lightdash.com/semantic-layer/lightdash-config-yml#metrics-catalog-configuration) (e.g. `default_visibility`, available `categories`)\n- **Metric/model level** — per-metric overrides, set under `meta.spotlight` in your dbt model `.yml` (see [curating the catalog](https://docs.lightdash.com/explore/metrics-catalog/curate-the-catalog#curating-metrics-catalog-for-your-business-users))\n\nWhenever you see `spotlight` in YAML, it's configuring something on this page.",
                sourceUrl:
                    'https://docs.lightdash.com/explore/metrics-catalog#the-spotlight-config',
                sourceLabel: 'The spotlight config',
                sourceHash:
                    '1db384e1d42a7dde8ed48367b77f58dbf384cb3cea14e86e15e03b214b90bd7b',
            },
        ],
    },
    'manage:SpotlightTableConfig': {
        ...
        sections: [
            {
                ...
                sourceHash:
                    'bec6bcc4a1fb8e5c2fa5726cb9bf38c4601b1a59eba2797c218d9f7c4126888b',
            },
            {
        ...
        sections: [
            {
                ...
                sourceHash:
                    '0d1c7cb00ca16ae3870d0e8e518a04ea0bc795a23801e51f8f0cba56951e34c1',
            },
        ],
    },
    'view:EmbedDashboardFilterAddition': {
    ...
    'view:EmbedDataApps': {
        ...
        sections: [
            {
                heading: 'Data app token',
                body: "For embedding a [data app](https://docs.lightdash.com/data-apps) as standalone content in an iframe (no dashboard). See [How to embed data apps](https://docs.lightdash.com/embed/embed-data-apps) for the full guide.\n\n```typescript\n{\n  content: {\n    type: 'dataApp',\n\n    // Data app identifier (required)\n    appUuid: string,\n\n    // Project identifier (optional)\n    projectUuid?: string,\n\n    // Preview mode (optional)\n    isPreview?: boolean,\n  },\n\n  // Optional: User information for query tracking\n  user?: {\n    externalId?: string,\n    email?: string,\n  },\n\n  // Optional: User attributes for row-level filtering\n  userAttributes?: {\n    [attributeName: string]: string,\n  },\n}\n```\n\nA `dataApp` token authorizes only the named app. It cannot render any other data app, chart, or dashboard, even if that content is on the embed allowlist, and interactivity options like `canExportCsv`, `canExplore`, and `dashboardFiltersInteractivity` do not apply to it.\n\nA data app can run arbitrary metric queries across the project. Minting a `dataApp` token means accepting project-wide column access for the app's queries. Row-level access via [user attributes](https://docs.lightdash.com/workspace-admin/user-attributes) is unchanged.\n\n**Example:**\n\n```javascript\nimport jwt from 'jsonwebtoken';\n\nconst token = jwt.sign({\n  content: {\n    type: 'dataApp',\n    projectUuid: 'your-project-uuid',\n    appUuid: 'your-app-uuid',\n  },\n  user: {\n    externalId: 'user-789',\n    email: 'user@example.com',\n  },\n  userAttributes: {\n    tenant_id: 'tenant-abc',\n  },\n}, SECRET, { expiresIn: '1h' });\n```",
                sourceUrl:
                    'https://docs.lightdash.com/embed/reference#data-app-token',
                sourceLabel: 'Data app token',
                sourceHash:
                    '0d1c7cb00ca16ae3870d0e8e518a04ea0bc795a23801e51f8f0cba56951e34c1',
            },
        ],
        ...
        sections: [
            {
                ...
                sourceHash:
                    '8eb78040c7beab3455f8f874677b413389bbe4ef071b5e84960e7eff72dc2345',
            },
        ],
    },
        ...
        sections: [
            {
                ...
                sourceHash:
                    '03f6e04f97057df40913385928bc2b8c998fb6f1bbd90dc4326cc5388d5550b9',
            },
            {
                heading: 'What to upload',
                body: 'Good candidates are anything a new analyst on your team would need to read before answering questions, but that doesn\'t belong in the semantic layer itself:\n\n- **Business glossaries** — definitions of terms like "active customer", "qualified lead", "churn", especially when your definition differs from the industry default\n- **Metric provenance and caveats** — "Revenue excludes refunds processed after the period close", "MRR is calculated on the first of the month, not rolling"\n- **Fiscal and calendar conventions** — fiscal year start, reporting cadence, holiday adjustments\n- **Org-specific acronyms and product taxonomy** — what your internal product codes mean, team naming conventions\n- **Known data quirks** — "The `eu_orders` table has a 6-hour ingestion lag", "Pre-2023 data uses the old pricing schema"\n- **Policy and escalation context** — when to flag something to a human, which numbers are board-reported and must match a specific source',
                sourceUrl:
                    'https://docs.lightdash.com/agents/effective-analytics-with-agents#what-to-upload',
                sourceLabel: 'What to upload',
                sourceHash:
                    '03f6e04f97057df40913385928bc2b8c998fb6f1bbd90dc4326cc5388d5550b9',
            },
        ],
