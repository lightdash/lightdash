import { DimensionType, FieldType, Metric, MetricType, TimeIntervalUnit } from '@lightdash/common';
import {
    DuckdbSqlBuilder,
...
const mockedDuckdb = jest.mocked(duckdb);
...
describe('DuckdbWarehouseClient', () => {
    beforeEach(() => {
        ...
        mockedDuckdb.Database.create.mockResolvedValue({
            connect: mockConnect,
            close: mockDbClose,
        } as any);
    });
