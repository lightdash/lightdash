...
test.describe('Field value search', () => {
    ...
    test('Should return empty results for non existing field search', async ({
        request,
    }) => {
        const response = await request.post(
            `${apiUrl}/projects/${SEED_PROJECT.project_uuid}/field/orders_status/search`,
    ...
    test('Should return empty results for invalid numeric search', async ({
        request,
    }) => {
        const response = await request.post(
    ...
    test('Should return empty results for invalid string search', async ({
        request,
    }) => {
        const response = await request.post(
            `${apiUrl}/projects/${SEED_PROJECT.project_uuid}/field/orders_status/search`,
