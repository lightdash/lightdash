...
test.describe('Lightdash API', () => {
    ...
    test('Should get success response (200) from GET public endpoints', async ({ request }) => {
    ...
    test('Should get success response (200) from GET projectRouter endpoints', async ({ request }) => {
    ...
    test('Should get success response (200) from POST runQuery', async ({ request }) => {
        const projectUuid = SEED_PROJECT.project_uuid;
    ...
    test('Should get success response (200) from POST sqlQuery', async ({ request }) => {
        const projectUuid = SEED_PROJECT.project_uuid;
    ...
    test('Should get success response (200) from PATCH project', async ({ request }) => {
        const projectUuid = SEED_PROJECT.project_uuid;
    ...
    test('Should get success response (200) from PATCH dashboard', async ({ request }) => {
        const projectUuid = SEED_PROJECT.project_uuid;
        ...
        expect(dashboardBody.results).toHaveProperty('name', 'Jaffle dashboard');
    ...
    test('Should get success response (200) from GET savedChartRouter endpoints', async ({ request }) => {
        const projectUuid = SEED_PROJECT.project_uuid;
    ...
    test('Should get success response (200) from GET organizationRouter endpoints', async ({ request }) => {
        const endpoints = [
            `/org`,
            `/org/projects`,
            `/org/users`,
    ...
    test('Should get not found response (404) from GET organizationRouter endpoints', async ({ request }) => {
    ...
    test('Should get success response (200) from GET userRouter endpoints', async ({ request }) => {
    ...
    test('Should get success response (200) from GET dashboardRouter endpoints', async ({ request }) => {
        const projectUuid = SEED_PROJECT.project_uuid;
    ...
    test('Should get metric filters from events', async ({ request }) => {
        const response = await request.get(`${apiUrl}/projects/${SEED_PROJECT.project_uuid}/explores/events`, {
            headers: { 'Content-type': 'application/json' },
        });
        ...
        const metricFilters = removeIds(
            body.results.tables.events.metrics.with_filters.filters as MetricFilterRule[],
        );
...
test.describe('Lightdash API forbidden tests', () => {
    ...
    test('Should get forbidden error (403) from PATCH project', async ({ request }) => {
        const projectUuid = SEED_PROJECT.project_uuid;
        const endpoint = `${apiUrl}/projects/${projectUuid}`;
