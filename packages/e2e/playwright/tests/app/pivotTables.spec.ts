...
test.describe('Pivot Tables', () => {
    test('Can view shared pivot table from URL in explore', async ({ adminPage: page }) => {
    ...
    test('Can create a pivot table chart on explore', async ({ adminPage: page }) => {
        // Navigate to the explore page
        await page.goto(
    ...
    test.skip('I can save a pivot table chart and add it to a dashboard', async ({
        ...
        await page.getByTestId('ChartCreateModal/NameInput').fill(
