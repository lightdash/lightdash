...
describe('Embedded dashboard abilities', () => {
    ...
    describe('Base abilities', () => {
        it('should allow viewing the specified dashboard', () => {
            ...
            expect(
                ability.can('view', subject('Dashboard', { dashboardUuid })),
            ).toBe(true);
        });

        it('should allow viewing non-private saved charts in the project', () => {
            const embedUser = createEmbedJwt();
            const ability = defineAbilityForEmbedUser(embedUser, dashboardUuid);
        ...
        it('should handle missing optional properties gracefully', () => {
            ...
            expect(ability.can('export', 'Dashboard', 'csv')).toBe(false);
            expect(ability.can('export', 'Dashboard', 'pdf')).toBe(false);
            expect(ability.can('export', 'Dashboard', 'images')).toBe(false);
    ...
    describe('Export abilities', () => {
        describe('CSV export', () => {
            it('should allow CSV export when canExportCsv is true', () => {
                ...
                expect(ability.can('export', 'Dashboard', 'csv')).toBe(true);
            });
        ...
        describe('PDF export', () => {
            it('should allow PDF export when canExportPagePdf is true', () => {
                ...
                expect(ability.can('export', 'Dashboard', 'pdf')).toBe(true);
            });
        ...
        describe('Images export', () => {
            it('should allow images export when canExportImages is true', () => {
                ...
                expect(ability.can('export', 'Dashboard', 'images')).toBe(true);
            });
            ...
            it('should not allow images export when canExportImages is false', () => {
                ...
                expect(ability.can('export', 'Dashboard', 'images')).toBe(
                    false,
                );
            });
        });
