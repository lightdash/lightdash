...
export const ExpectedInTheCurrentFilterSQL: Record<UnitOfTime, string> = {
    [UnitOfTime.milliseconds]: `((customers.created) >= ('2020-04-04 06:12:30+00') AND (customers.created) <= ('2020-04-04 06:12:30+00'))`, // note that all milliseconds filters are working incorrectly #4074
    [UnitOfTime.seconds]: `((customers.created) >= ('2020-04-04 06:12:30+00') AND (customers.created) <= ('2020-04-04 06:12:30+00'))`,
    [UnitOfTime.minutes]: `((customers.created) >= ('2020-04-04 06:12:00+00') AND (customers.created) <= ('2020-04-04 06:12:59+00'))`,
    [UnitOfTime.hours]: `((customers.created) >= ('2020-04-04 06:00:00+00') AND (customers.created) <= ('2020-04-04 06:59:59+00'))`,
    [UnitOfTime.days]: `((customers.created) >= ('2020-04-04 00:00:00+00') AND (customers.created) <= ('2020-04-04 23:59:59+00'))`,
    [UnitOfTime.weeks]: `((customers.created) >= ('2020-03-30 00:00:00+00') AND (customers.created) <= ('2020-04-05 23:59:59+00'))`,
    [UnitOfTime.months]: `((customers.created) >= ('2020-04-01 00:00:00+00') AND (customers.created) <= ('2020-04-30 23:59:59+00'))`,
    [UnitOfTime.quarters]: `((customers.created) >= ('2020-04-01 00:00:00+00') AND (customers.created) <= ('2020-06-30 23:59:59+00'))`,
    [UnitOfTime.years]: `((customers.created) >= ('2020-01-01 00:00:00+00') AND (customers.created) <= ('2020-12-31 23:59:59+00'))`,
};

export const TrinoExpectedInTheCurrentFilterSQL: Record<UnitOfTime, string> = {
    [UnitOfTime.milliseconds]: `((customers.created) >= CAST('2020-04-04 06:12:30+00' AS timestamp) AND (customers.created) <= CAST('2020-04-04 06:12:30+00' AS timestamp))`, // note that all milliseconds filters are working incorrectly #4074
    [UnitOfTime.seconds]: `((customers.created) >= CAST('2020-04-04 06:12:30+00' AS timestamp) AND (customers.created) <= CAST('2020-04-04 06:12:30+00' AS timestamp))`,
    [UnitOfTime.minutes]: `((customers.created) >= CAST('2020-04-04 06:12:00+00' AS timestamp) AND (customers.created) <= CAST('2020-04-04 06:12:59+00' AS timestamp))`,
    [UnitOfTime.hours]: `((customers.created) >= CAST('2020-04-04 06:00:00+00' AS timestamp) AND (customers.created) <= CAST('2020-04-04 06:59:59+00' AS timestamp))`,
    [UnitOfTime.days]: `((customers.created) >= CAST('2020-04-04 00:00:00+00' AS timestamp) AND (customers.created) <= CAST('2020-04-04 23:59:59+00' AS timestamp))`,
    [UnitOfTime.weeks]: `((customers.created) >= CAST('2020-03-30 00:00:00+00' AS timestamp) AND (customers.created) <= CAST('2020-04-05 23:59:59+00' AS timestamp))`,
    [UnitOfTime.months]: `((customers.created) >= CAST('2020-04-01 00:00:00+00' AS timestamp) AND (customers.created) <= CAST('2020-04-30 23:59:59+00' AS timestamp))`,
    [UnitOfTime.quarters]: `((customers.created) >= CAST('2020-04-01 00:00:00+00' AS timestamp) AND (customers.created) <= CAST('2020-06-30 23:59:59+00' AS timestamp))`,
    [UnitOfTime.years]: `((customers.created) >= CAST('2020-01-01 00:00:00+00' AS timestamp) AND (customers.created) <= CAST('2020-12-31 23:59:59+00' AS timestamp))`,
};
...
export const ExpectedInTheNextFilterSQL: Record<UnitOfTime, string> = {
    [UnitOfTime.milliseconds]: `((customers.created) >= ('2020-04-04 06:12:30+00') AND (customers.created) <= ('2020-04-04 06:12:30+00'))`, // note that all milliseconds filters are working incorrectly #4074
    [UnitOfTime.seconds]: `((customers.created) >= ('2020-04-04 06:12:30+00') AND (customers.created) <= ('2020-04-04 06:12:31+00'))`,
    [UnitOfTime.minutes]: `((customers.created) >= ('2020-04-04 06:12:30+00') AND (customers.created) <= ('2020-04-04 06:13:30+00'))`,
    [UnitOfTime.hours]: `((customers.created) >= ('2020-04-04 06:12:30+00') AND (customers.created) <= ('2020-04-04 07:12:30+00'))`,
    [UnitOfTime.days]: `((customers.created) >= ('2020-04-04 06:12:30+00') AND (customers.created) <= ('2020-04-05 06:12:30+00'))`,
    [UnitOfTime.weeks]: `((customers.created) >= ('2020-04-04 06:12:30+00') AND (customers.created) <= ('2020-04-11 06:12:30+00'))`,
    [UnitOfTime.months]: `((customers.created) >= ('2020-04-04 06:12:30+00') AND (customers.created) <= ('2020-05-04 06:12:30+00'))`,
    [UnitOfTime.quarters]: `((customers.created) >= ('2020-04-04 06:12:30+00') AND (customers.created) <= ('2020-07-04 06:12:30+00'))`,
    [UnitOfTime.years]: `((customers.created) >= ('2020-04-04 06:12:30+00') AND (customers.created) <= ('2021-04-04 06:12:30+00'))`,
};

export const TrinoExpectedInTheNextFilterSQL: Record<UnitOfTime, string> = {
    [UnitOfTime.milliseconds]: `((customers.created) >= CAST('2020-04-04 06:12:30+00' AS timestamp) AND (customers.created) <= CAST('2020-04-04 06:12:30+00' AS timestamp))`, // note that all milliseconds filters are working incorrectly #4074
    [UnitOfTime.seconds]: `((customers.created) >= CAST('2020-04-04 06:12:30+00' AS timestamp) AND (customers.created) <= CAST('2020-04-04 06:12:31+00' AS timestamp))`,
    [UnitOfTime.minutes]: `((customers.created) >= CAST('2020-04-04 06:12:30+00' AS timestamp) AND (customers.created) <= CAST('2020-04-04 06:13:30+00' AS timestamp))`,
    [UnitOfTime.hours]: `((customers.created) >= CAST('2020-04-04 06:12:30+00' AS timestamp) AND (customers.created) <= CAST('2020-04-04 07:12:30+00' AS timestamp))`,
    [UnitOfTime.days]: `((customers.created) >= CAST('2020-04-04 06:12:30+00' AS timestamp) AND (customers.created) <= CAST('2020-04-05 06:12:30+00' AS timestamp))`,
    [UnitOfTime.weeks]: `((customers.created) >= CAST('2020-04-04 06:12:30+00' AS timestamp) AND (customers.created) <= CAST('2020-04-11 06:12:30+00' AS timestamp))`,
    [UnitOfTime.months]: `((customers.created) >= CAST('2020-04-04 06:12:30+00' AS timestamp) AND (customers.created) <= CAST('2020-05-04 06:12:30+00' AS timestamp))`,
    [UnitOfTime.quarters]: `((customers.created) >= CAST('2020-04-04 06:12:30+00' AS timestamp) AND (customers.created) <= CAST('2020-07-04 06:12:30+00' AS timestamp))`,
    [UnitOfTime.years]: `((customers.created) >= CAST('2020-04-04 06:12:30+00' AS timestamp) AND (customers.created) <= CAST('2021-04-04 06:12:30+00' AS timestamp))`,
};

export const ExpectedInTheNextCompleteFilterSQL: Record<UnitOfTime, string> = {
    [UnitOfTime.milliseconds]: `((customers.created) >= ('2020-04-04 06:12:30+00') AND (customers.created) < ('2020-04-04 06:12:30+00'))`, // note that all milliseconds filters are working incorrectly #4074
    [UnitOfTime.seconds]: `((customers.created) >= ('2020-04-04 06:12:31+00') AND (customers.created) < ('2020-04-04 06:12:32+00'))`,
    [UnitOfTime.minutes]: `((customers.created) >= ('2020-04-04 06:13:00+00') AND (customers.created) < ('2020-04-04 06:14:00+00'))`,
    [UnitOfTime.hours]: `((customers.created) >= ('2020-04-04 07:00:00+00') AND (customers.created) < ('2020-04-04 08:00:00+00'))`,
    [UnitOfTime.days]: `((customers.created) >= ('2020-04-05 00:00:00+00') AND (customers.created) < ('2020-04-06 00:00:00+00'))`,
    [UnitOfTime.weeks]: `((customers.created) >= ('2020-04-06 00:00:00+00') AND (customers.created) < ('2020-04-13 00:00:00+00'))`,
    [UnitOfTime.months]: `((customers.created) >= ('2020-05-01 00:00:00+00') AND (customers.created) < ('2020-06-01 00:00:00+00'))`,
    [UnitOfTime.quarters]: `((customers.created) >= ('2020-07-01 00:00:00+00') AND (customers.created) < ('2020-10-01 00:00:00+00'))`,
    [UnitOfTime.years]: `((customers.created) >= ('2021-01-01 00:00:00+00') AND (customers.created) < ('2022-01-01 00:00:00+00'))`,
};
...
> = {
    [UnitOfTime.milliseconds]: `((customers.created) >= CAST('2020-04-04 06:12:30+00' AS timestamp) AND (customers.created) < CAST('2020-04-04 06:12:30+00' AS timestamp))`, // note that all milliseconds filters are working incorrectly #4074
    [UnitOfTime.seconds]: `((customers.created) >= CAST('2020-04-04 06:12:31+00' AS timestamp) AND (customers.created) < CAST('2020-04-04 06:12:32+00' AS timestamp))`,
    [UnitOfTime.minutes]: `((customers.created) >= CAST('2020-04-04 06:13:00+00' AS timestamp) AND (customers.created) < CAST('2020-04-04 06:14:00+00' AS timestamp))`,
    [UnitOfTime.hours]: `((customers.created) >= CAST('2020-04-04 07:00:00+00' AS timestamp) AND (customers.created) < CAST('2020-04-04 08:00:00+00' AS timestamp))`,
    [UnitOfTime.days]: `((customers.created) >= CAST('2020-04-05 00:00:00+00' AS timestamp) AND (customers.created) < CAST('2020-04-06 00:00:00+00' AS timestamp))`,
    [UnitOfTime.weeks]: `((customers.created) >= CAST('2020-04-06 00:00:00+00' AS timestamp) AND (customers.created) < CAST('2020-04-13 00:00:00+00' AS timestamp))`,
    [UnitOfTime.months]: `((customers.created) >= CAST('2020-05-01 00:00:00+00' AS timestamp) AND (customers.created) < CAST('2020-06-01 00:00:00+00' AS timestamp))`,
    [UnitOfTime.quarters]: `((customers.created) >= CAST('2020-07-01 00:00:00+00' AS timestamp) AND (customers.created) < CAST('2020-10-01 00:00:00+00' AS timestamp))`,
    [UnitOfTime.years]: `((customers.created) >= CAST('2021-01-01 00:00:00+00' AS timestamp) AND (customers.created) < CAST('2022-01-01 00:00:00+00' AS timestamp))`,
};
...
export const ExpectedInThePastCompleteWeekFilterSQLWithCustomStartOfWeek: Record<
    ...
    string
> = {
    [WeekDay.MONDAY]: `((customers.created) >= ('2020-03-23 00:00:00+00') AND (customers.created) < ('2020-03-30 00:00:00+00'))`,
    [WeekDay.SUNDAY]: `((customers.created) >= ('2020-03-22 00:00:00+00') AND (customers.created) < ('2020-03-29 00:00:00+00'))`,
};
...
export const TrinoExpectedInThePastCompleteWeekFilterSQLWithCustomStartOfWeek: Record<
    ...
    string
> = {
    [WeekDay.MONDAY]: `((customers.created) >= CAST('2020-03-23 00:00:00+00' AS timestamp) AND (customers.created) < CAST('2020-03-30 00:00:00+00' AS timestamp))`,
    [WeekDay.SUNDAY]: `((customers.created) >= CAST('2020-03-22 00:00:00+00' AS timestamp) AND (customers.created) < CAST('2020-03-29 00:00:00+00' AS timestamp))`,
};
...
export const ExpectedInTheCurrentWeekFilterSQLWithCustomStartOfWeek: Record<
    ...
    string
> = {
    [WeekDay.MONDAY]: `((customers.created) >= ('2020-03-30 00:00:00+00') AND (customers.created) <= ('2020-04-05 23:59:59+00'))`,
    [WeekDay.SUNDAY]: `((customers.created) >= ('2020-03-29 00:00:00+00') AND (customers.created) <= ('2020-04-04 23:59:59+00'))`,
};
export const TrinoExpectedInTheCurrentWeekFilterSQLWithCustomStartOfWeek: Record<
    WeekDay.MONDAY | WeekDay.SUNDAY,
    string
> = {
    [WeekDay.MONDAY]: `((customers.created) >= CAST('2020-03-30 00:00:00+00' AS timestamp) AND (customers.created) <= CAST('2020-04-05 23:59:59+00' AS timestamp))`,
    [WeekDay.SUNDAY]: `((customers.created) >= CAST('2020-03-29 00:00:00+00' AS timestamp) AND (customers.created) <= CAST('2020-04-04 23:59:59+00' AS timestamp))`,
};
export const ExpectedInTheNextCompleteWeekFilterSQLWithCustomStartOfWeek: Record<
    WeekDay.MONDAY | WeekDay.SUNDAY,
    string
> = {
    [WeekDay.MONDAY]: `((customers.created) >= ('2020-04-06 00:00:00+00') AND (customers.created) < ('2020-04-13 00:00:00+00'))`,
    [WeekDay.SUNDAY]: `((customers.created) >= ('2020-04-05 00:00:00+00') AND (customers.created) < ('2020-04-12 00:00:00+00'))`,
};
...
export const TrinoExpectedInTheNextCompleteWeekFilterSQLWithCustomStartOfWeek: Record<
    ...
    string
> = {
    [WeekDay.MONDAY]: `((customers.created) >= CAST('2020-04-06 00:00:00+00' AS timestamp) AND (customers.created) < CAST('2020-04-13 00:00:00+00' AS timestamp))`,
    [WeekDay.SUNDAY]: `((customers.created) >= CAST('2020-04-05 00:00:00+00' AS timestamp) AND (customers.created) < CAST('2020-04-12 00:00:00+00' AS timestamp))`,
};
...
export const InTheLast1HourFilterSQL = `((customers.created) >= ('2020-04-04 05:12:30+00') AND (customers.created) <= ('2020-04-04 06:12:30+00'))`;

export const TrinoInTheLast1HourFilterSQL = `((customers.created) >= CAST('2020-04-04 05:12:30+00' AS timestamp) AND (customers.created) <= CAST('2020-04-04 06:12:30+00' AS timestamp))`;
...
export const InTheLast1CompletedHourFilterSQL = `((customers.created) >= ('2020-04-04 05:00:00+00') AND (customers.created) < ('2020-04-04 06:00:00+00'))`;

export const TrinoInTheLast1CompletedHourFilterSQL = `((customers.created) >= CAST('2020-04-04 05:00:00+00' AS timestamp) AND (customers.created) < CAST('2020-04-04 06:00:00+00' AS timestamp))`;
...
export const InTheLast1MinuteFilterSQL = `((customers.created) >= ('2020-04-04 06:11:30+00') AND (customers.created) <= ('2020-04-04 06:12:30+00'))`;

export const TrinoInTheLast1MinuteFilterSQL = `((customers.created) >= CAST('2020-04-04 06:11:30+00' AS timestamp) AND (customers.created) <= CAST('2020-04-04 06:12:30+00' AS timestamp))`;
...
export const InTheLast1CompletedMinuteFilterSQL = `((customers.created) >= ('2020-04-04 06:11:00+00') AND (customers.created) < ('2020-04-04 06:12:00+00'))`;

export const TrinoInTheLast1CompletedMinuteFilterSQL = `((customers.created) >= CAST('2020-04-04 06:11:00+00' AS timestamp) AND (customers.created) < CAST('2020-04-04 06:12:00+00' AS timestamp))`;
...
export const InBetweenPastTwoYearsTimestampFilterSQL = `((customers.created) >= ('2021-04-04 00:00:00+00') AND (customers.created) <= ('2023-04-04 00:00:00+00'))`;
export const TrinoInBetweenPastTwoYearsTimestampFilterSQL = `((customers.created) >= CAST('2021-04-04 00:00:00+00' AS timestamp) AND (customers.created) <= CAST('2023-04-04 00:00:00+00' AS timestamp))`;
...
export const filterInThePastCompletedDayTimezoneMocks = [
    [
        'UTC',
        "((customers.created) >= ('2020-04-03 00:00:00+00') AND (customers.created) < ('2020-04-04 00:00:00+00'))",
    ],
    [
        'America/New_York',
        "((customers.created) >= ('2020-04-03 04:00:00+00') AND (customers.created) < ('2020-04-04 04:00:00+00'))",
    ],
];
...
export const filterInTheNextCompletedDayTimezoneMocks = [
    [
        'UTC',
        "((customers.created) >= ('2020-04-05 00:00:00+00') AND (customers.created) < ('2020-04-06 00:00:00+00'))",
    ],
    [
        'America/New_York',
        "((customers.created) >= ('2020-04-05 04:00:00+00') AND (customers.created) < ('2020-04-06 04:00:00+00'))",
    ],
];
...
export const filterInThePastCompletedDayDstMocks = [
    [
        'UTC',
        "((customers.created) >= ('2020-03-08 00:00:00+00') AND (customers.created) < ('2020-03-09 00:00:00+00'))",
    ],
    [
        'America/New_York',
        "((customers.created) >= ('2020-03-08 05:00:00+00') AND (customers.created) < ('2020-03-09 04:00:00+00'))",
    ],
];
...
export const filterInThePastNonCompletedDayTimezoneMocks = [
    [
        'UTC',
        "((customers.created) >= ('2020-04-03 06:12:30+00') AND (customers.created) <= ('2020-04-04 06:12:30+00'))",
    ],
    [
        'America/New_York',
        "((customers.created) >= ('2020-04-03 06:12:30+00') AND (customers.created) <= ('2020-04-04 06:12:30+00'))",
...
export const filterInTheNextNonCompletedDayTimezoneMocks = [
    [
        'UTC',
        "((customers.created) >= ('2020-04-04 06:12:30+00') AND (customers.created) <= ('2020-04-05 06:12:30+00'))",
    ],
    [
        'America/New_York',
        "((customers.created) >= ('2020-04-04 06:12:30+00') AND (customers.created) <= ('2020-04-05 06:12:30+00'))",
...
export const filterInTheCurrentDayTimezoneMocks = [
    [
        'UTC',
        "((customers.created) >= ('2020-04-04 00:00:00+00') AND (customers.created) <= ('2020-04-04 23:59:59+00'))",
    ],
    [
        'America/New_York',
        "((customers.created) >= ('2020-04-04 04:00:00+00') AND (customers.created) <= ('2020-04-05 03:59:59+00'))",
    ],
    [
        'Asia/Bangkok',
        "((customers.created) >= ('2020-04-03 17:00:00+00') AND (customers.created) <= ('2020-04-04 16:59:59+00'))",
    ],
    [
        'Pacific/Fiji',
        "((customers.created) >= ('2020-04-03 12:00:00+00') AND (customers.created) <= ('2020-04-04 11:59:59+00'))",
    ],
];
