...
describe('convert tables from dbt models', () => {
    ...
    it('should convert dimension filter autocomplete enabled false to a disabled config', () => {
        const table = convertTable(
            SupportedDbtAdapter.BIGQUERY,
            {
                ...MODEL_WITH_NO_METRICS,
    ...
    it('should warn and drop values and label_dimension when filter autocomplete is disabled', () => {
        const table = convertTable(
            SupportedDbtAdapter.BIGQUERY,
            {
                ...MODEL_WITH_NO_METRICS,
        ...
        expect(table.warnings).toEqual([
            {
                ...
                message:
                    'Ignoring filter_autocomplete values and label_dimension for dimension "user_id" in dbt model "myTable" because autocomplete is disabled (enabled: false).',
            },
        ]);
    });
