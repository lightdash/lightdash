...
export const MODEL_WITH_AI_HINT: DbtModelNode & {
    ...
    meta: {
        ai: {
            hint: 'This is a customers table.',
        },
    },
};
...
export const MODEL_WITH_AI_HINT_IN_CONFIG: DbtModelNode & {
    ...
    config: {
        meta: {
            ai: {
                hint: 'This is a customers table from config.',
            },
        },
    },
    meta: {},
    ...
    columns: {
        user_name: {
            ...
            meta: {
                dimension: {
                    ai: {
                        hint: 'User name dimension with AI hint.',
                    },
                },
            },
        },
            ...
            meta: {
                metrics: {
                    user_count_with_ai: {
                        type: MetricType.COUNT_DISTINCT,
                        ai: {
                            hint: 'Count of unique users with AI hint.',
                        },
                    },
                },
            },
    ...
    meta: {
        metrics: {
            completion_percentage: {
                ...
                ai: {
                    hint: 'Completion percentage of orders.',
                },
            },
        },
    },
