...
export const SDK_FEATURES: SdkFeature[] = [
    ...
    },
    {
        ...
        wiring: 'Declare multiple: true for a viz schema field, then handle fieldMapping[name] as an ordered array of query field ids; scalar declarations still deliver one string.',
    },
    {
