...
export const TOOL_DISPLAY_MESSAGES = ToolDisplayMessagesSchema.parse({
    ...
    frontendAction: 'Working in the app',
    ...
    loadSkillResource: 'Loading built-in skill resource',
...
export const TOOL_DISPLAY_MESSAGES_AFTER_TOOL_CALL =
    ToolDisplayMessagesSchema.parse({
        ...
        frontendAction: 'Completed app action',
        ...
        loadSkillResource: 'Loaded built-in skill resource',
