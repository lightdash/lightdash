...
export const TOOL_GET_QUERY_RESULT_DESCRIPTION = `Poll an existing run_sql or run_metric_query query. Use the exact queryUuid returned by the query tool; never invent it. This tool retrieves results without rerunning the query.
