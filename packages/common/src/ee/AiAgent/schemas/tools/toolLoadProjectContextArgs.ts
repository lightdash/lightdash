...
export const TOOL_LOAD_PROJECT_CONTEXT_DESCRIPTION =
    'Load the project business context: curated acronyms, definitions, rules and conventions that are NOT in the field metadata. Call this BEFORE explore/field discovery — it can change which explore, field, or filter value you should use. Treat what it returns as authoritative over your own assumptions.';
