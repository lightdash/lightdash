...
export const EE_SCHEDULER_TASKS = {
    ...
    SWEEP_STALE_AI_AGENT_V3_RUNS: 'sweepStaleAiAgentV3Runs',
...
export interface TaskPayloadMap {
    ...
    [SCHEDULER_TASKS.SWEEP_STALE_AI_AGENT_V3_RUNS]: TraceTaskBase;
...
export interface EETaskPayloadMap {
    ...
    [EE_SCHEDULER_TASKS.SWEEP_STALE_AI_AGENT_V3_RUNS]: TraceTaskBase;
