import {
    ...
    type ParsedFilter as FilterParserParsedFilter,
} from '@lightdash/filter-parser';
...
export type ParsedFilter = Omit<FilterParserParsedFilter, 'values'> & {
    values: AnyType[];
};

const filterParserOptions: FilterParserOptions = {
    operators: {
...
export const parseFilters = (
    ...
    return rawFilters.reduce<MetricFilterRule[]>((acc, filter) => {
        ...
        if (typeof value === 'string') {
            const parsedFilter = parseFilterExpression(
                value,
                filterParserOptions,
            ) as ParsedFilter;
