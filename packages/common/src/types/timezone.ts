// IANA zones from Intl.supportedValuesOf('timeZone') (Node 24), plus existing picker aliases.
// Keep this list static so browsers and backend validation offer the same choices.
