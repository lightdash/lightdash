...
export async function down(knex: Knex): Promise<void> {
    await knex.schema.alterTable(QUERY_HISTORY_TABLE, (table) => {
        ...
        table.dropIndex(['project_uuid'], 'idx_query_history_project_uuid');
        table.dropIndex(
            ['created_by_user_uuid'],
            'idx_query_history_created_by_user_uuid',
        );
        ...
        table.dropIndex(['created_at'], 'idx_query_history_created_at');
    });
}
