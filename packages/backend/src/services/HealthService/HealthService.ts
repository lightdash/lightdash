...
export class HealthService extends BaseService {
    ...
    async getHealthState(user: SessionUser | undefined): Promise<HealthState> {
        ...
        return {
            ...
            siteLogoAlt: this.lightdashConfig.siteLogoAlt,
            siteLogoDark: this.lightdashConfig.siteLogoDark,
            siteLogoBlack: this.lightdashConfig.siteLogoBlack,
            siteLogoWhite: this.lightdashConfig.siteLogoWhite,
            siteTouchIconGrey: this.lightdashConfig.siteTouchIconGrey,
            siteTitleText: this.lightdashConfig.siteTitleText,
            siteFavicon: this.lightdashConfig.siteFavicon,
            siteTouchIcon: this.lightdashConfig.siteTouchIcon,
            siteGithubIcon: this.lightdashConfig.siteGithubIcon,
            siteGithubUrl: this.lightdashConfig.siteGithubUrl,
            siteLinkedinIcon: this.lightdashConfig.siteLinkedinIcon,
            siteLinkedinUrl: this.lightdashConfig.siteLinkedinUrl,
            siteTwitterIcon: this.lightdashConfig.siteTwitterIcon,
            siteSlackCommunityUrl: this.lightdashConfig.siteSlackCommunityUrl,
            siteTwitterUrl: this.lightdashConfig.siteTwitterUrl,
            siteHelpdeskUrl: this.lightdashConfig.siteHelpdeskUrl,
            supportEmail: this.lightdashConfig.supportEmail,
            sitePrivacyPolicyUrl: this.lightdashConfig.sitePrivacyPolicyUrl,
            siteTOSUrl: this.lightdashConfig.siteTOSUrl,
