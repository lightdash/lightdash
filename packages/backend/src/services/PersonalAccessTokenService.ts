...
export class PersonalAccessTokenService extends BaseService {
    ...
    async createPersonalAccessToken(
        ...
        if (
            auditedAbility.cannot('create', subject('PersonalAccessToken', {}))
        ) {
    ...
    async deletePersonalAccessToken(
        ...
        const auditedAbility = this.createAuditedAbility(user);
        if (
            auditedAbility.cannot('delete', subject('PersonalAccessToken', {}))
        ) {
            throw new ForbiddenError(
    ...
    async rotatePersonalAccessToken(
        ...
        const auditedAbility = this.createAuditedAbility(user);
        if (
            auditedAbility.cannot('update', subject('PersonalAccessToken', {}))
        ) {
            throw new ForbiddenError(
