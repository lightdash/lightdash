    ...
    async getSearchResults(
        ...
        return wrapSentryTransaction(
            ...
            async (span) => {
                ...
                span.setAttribute('spaceUuidsCount', spaceUuids.length);
                span.setAttribute('dashboardsCount', results.dashboards.length);
                span.setAttribute(
                    'savedChartsCount',
                    results.savedCharts.length,
                );
                span.setAttribute('fieldsCount', results.fields.length);
                ...
                if (hasExploreAccess) {
                    if (
                        dimensionsHaveUserAttributes ||
                        tablesHaveUserAttributes
                    ) {
