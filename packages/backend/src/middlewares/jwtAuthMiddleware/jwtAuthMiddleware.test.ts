...
describe('Embed Auth Middleware', () => {
    ...
    const mockEmbedJwt: CreateEmbedJwt = {
        content: {
            type: 'dashboard',
    ...
    const mockAccount: AnonymousAccount = fromJwt({
        source: mockEmbedToken,
        decodedToken: mockEmbedJwt,
        embed: {
            encodedSecret: mockEncodedSecret.toString(),
