...
export const aiUsageCompactedColumns: CompactedStreamColumn[] = [
    ...
    { name: 'key_management', type: 'VARCHAR' },
    { name: 'managed_agent_run_id', type: 'VARCHAR' },
    { name: 'deep_research_run_id', type: 'VARCHAR' },
    { name: 'deep_research_phase', type: 'VARCHAR' },
...
const projectAiUsageEvent = (payload: AiUsageEvent): ProjectionResult => {
    ...
    return {
        ...
        row: {
            ...
            managed_agent_run_id: properties.managedAgentRunId ?? null,
            deep_research_run_id: properties.deepResearchRunId,
            deep_research_phase: properties.deepResearchPhase,
