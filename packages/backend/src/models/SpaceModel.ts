...
export class SpaceModel {
    ...
    > {
        ...
        const ancestors = await this.database(SpaceTableName)
            .select('space_uuid', 'name', 'inherit_parent_permissions', 'path')
            .whereRaw(`?::ltree <@ ${SpaceTableName}.path`, [space.path])
        ...
        for (const ancestor of ancestors) {
            chain.push({
                ...
                inheritParentPermissions: ancestor.inherit_parent_permissions,
            });
