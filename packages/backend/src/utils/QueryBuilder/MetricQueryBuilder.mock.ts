...
export const METRIC_QUERY: CompiledMetricQuery = {
    ...
    filters: {},
    sorts: [{ fieldId: 'table1_metric1', descending: true, nullsFirst: null }],
    limit: 10,
    tableCalculations: [
        {
            name: 'calc3',
...
export const METRIC_QUERY_TWO_TABLES: CompiledMetricQuery = {
    ...
    filters: {},
    sorts: [{ fieldId: 'table2_metric2', descending: true, nullsFirst: null }],
    limit: 10,
    tableCalculations: [
        {
            name: 'calc3',
...
export const METRIC_QUERY_WITH_FILTER: CompiledMetricQuery = {
    ...
    sorts: [{ fieldId: 'table1_dim1', descending: true, nullsFirst: null }],
    limit: 10,
    tableCalculations: [],
    compiledTableCalculations: [],
    compiledAdditionalMetrics: [],
