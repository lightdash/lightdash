...
const validateQueryTool = (
    ...
    // Validate dimensions (including breakdown dimension if present)
    const allDimensions = [
        ...queryTool.queryConfig.dimensions,
        ...(queryTool.queryConfig.breakdownByDimension
            ? [queryTool.queryConfig.breakdownByDimension]
            : []),
    ];
    validateFieldEntityType(explore, allDimensions, 'dimension');
    ...
    tool({
        ...
        execute: async (toolArgs) => {
            try {
                ...
                // TODO: Add Slack rendering support here if needed
                // For now, skip Slack rendering as per plan
