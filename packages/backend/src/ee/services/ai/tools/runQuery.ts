...
const sendSlackVisualization = async ({
    ...
    sendFile: SendFileFn;
    exportCustomChartTypeImage: (() => Promise<Buffer>) | null;
    ...
    if (
        ...
        const chartImage = await exportCustomChartTypeImageBounded(
            exportCustomChartTypeImage,
        );
        if (chartImage) {
            return sendFile({
                ...
                title: queryTool.title || 'Generated by Lightdash',
                comment:
                    queryTool.description || 'Chart generated by Lightdash',
                filename: 'lightdash-chart.png',
                file: chartImage,
            });
        }
                ...
                if (queryTool.mergeConfig) {
                    ...
                    if (isSlackPrompt(prompt)) {
                        chartImageUrl = await sendSlackVisualization({
                            ...
                            exportCustomChartTypeImage: null,
                        });
                    }
