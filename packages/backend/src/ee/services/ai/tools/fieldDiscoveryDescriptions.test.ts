...
describe('field discovery descriptions', () => {
    it('does not truncate explore descriptions and omits top matching field descriptions', async () => {
        ...
        expect(output.result).not.toContain(preview(longFieldDescription));
