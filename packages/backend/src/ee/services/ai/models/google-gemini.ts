...
// Lightdash reconstructs and sends the full conversation on every request, so
// Google-side Interaction storage adds retention without providing continuity.
// Enforce this at the model boundary so call sites cannot opt back into storage.
