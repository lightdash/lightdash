...
```json
{
    "chartConfig": {
        "config": {
            "groupFieldIds": ["products_category", "products_subcategory"],
    ...
    "contentType": "chart",
    "metricQuery": {
        "dimensions": ["products_category", "products_subcategory"],
        "exploreName": "products",
        "limit": 50,
        "metrics": ["products_total_revenue"],
        "sorts": [
            {
                "descending": true,
...
```json
{
    "chartConfig": {
        "config": {
            ...
            "endColor": "#22c55e",
            "groupFieldIds": ["products_category"],
            "sizeMetricId": "products_total_revenue",
            "startColor": "#ef4444"
        },
        "type": "treemap"
    ...
    "contentType": "chart",
    "metricQuery": {
        "dimensions": ["products_category"],
        "exploreName": "products",
        "limit": 25,
        "metrics": ["products_total_revenue", "products_profit_margin"],
        "sorts": [
            {
                "descending": true,
                "fieldId": "products_total_revenue"
