...
1. **Start with templates**: Use Lightdash's UI template gallery when creating custom visualizations interactively, then export to JSON
...
5. **Testing**: Test your Vega-Lite spec in the [Vega-Lite editor](https://vega.github.io/editor/) before adding to JSON charts
