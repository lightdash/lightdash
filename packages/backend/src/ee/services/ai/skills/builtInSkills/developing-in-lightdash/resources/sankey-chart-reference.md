...
Guide for configuring Sankey charts in Lightdash JSON charts.
...
```json
{
    ...
    "contentType": "chart",
    "metricQuery": {
        "dimensions": ["sankey_demo_source", "sankey_demo_target"],
        "exploreName": "sankey_demo",
        "limit": 500,
        "metrics": ["sankey_demo_total_weight"],
        "sorts": [
            {
                "descending": true,
...
- Reduce label length by editing dimension labels in the model JSON.
