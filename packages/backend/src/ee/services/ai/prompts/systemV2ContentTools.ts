...
- Once the destination is established, use listContent/findContent to resolve its authorized Space and createContent with type document, schemaVersion 3, name, slug, description, spaceSlug, and content: { cells: [...] }.
