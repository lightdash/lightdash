...
/**
 * Organization templates (uploaded packages) seed the same way as the
 * built-in starters: only the first build of a fresh sandbox, since
 * iterations own their source and a resumed sandbox restores it.
 */
