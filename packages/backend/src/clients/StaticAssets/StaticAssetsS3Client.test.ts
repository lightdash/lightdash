...
describe('StaticAssetsS3Client', () => {
    ...
    describe('getAsset', () => {
        it('fetches under the assets/ prefix and treats a missing object as a silent miss', async () => {
            ...
            // silently. Only genuine missing objects resolve to null;
            // authorization failures must remain retryable.
            ...
            await expect(createClient().getAsset('chunk.js')).rejects.toThrow(
                'denied',
            );
