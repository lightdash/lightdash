...
export default class EmailClient {
    ...
    private truncateEmailBlock = () =>
        // This block has been extracted from the email template generated by Tabular
        `
        <tr><td>
            <table class="t465" role="presentation" cellpadding="0" cellspacing="0" align="center"><tbody><tr>
            <td class="t466" style="background-color:#FFFFFF;overflow:hidden;width:580px;padding:20px 20px 20px 20px;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tbody><tr><td>
            <table class="t469" role="presentation" cellpadding="0" cellspacing="0" align="center"><tbody><tr>
            <td class="t470" style="background-color:#F5F5FF;overflow:hidden;width:628px;padding:16px 10px 16px 10px;border-radius:6px 6px 6px 6px;">
            <div class="t476" style="display:inline-table;width:100%;text-align:center;vertical-align:middle;">
            <div class="t480" style="display:inline-table;text-align:initial;vertical-align:inherit;width:100%;max-width:1113px;"><div class="t481" style="padding:0 5px 0 5px;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="t482"><tbody><tr>
