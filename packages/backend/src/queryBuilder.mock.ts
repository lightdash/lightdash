...
export const EXPLORE_WITH_VARIABLES: Explore = {
    targetDatabase: SupportedDbtAdapter.POSTGRES,
    name: 'explore_with_variables',
    label: 'Explore With Variables',
    baseTable: 'table1',
    tags: [],
    tables: {
        table1: {
            ...
            dimensions: {
                dim1: {
                    ...
                    tableLabel: 'Table 1',
                    fieldType: FieldType.DIMENSION,
                    sql: '${TABLE}.dim1 WHERE ${TABLE}.created_at >= ${date_filter}',
                    compiledSql:
                        '"table1".dim1 WHERE "table1".created_at >= ${table1.date_filter}',
                    tablesReferences: ['table1'],
                    hidden: false,
                },
            },
        ...
        table2: {
            ...
            dimensions: {
                dim1: {
                    ...
                    tableLabel: 'Table 2',
                    fieldType: FieldType.DIMENSION,
                    sql: '${TABLE}.dim1 WHERE ${TABLE}.updated_at >= ${date_filter}',
                    compiledSql:
                        '"table2".dim1 WHERE "table2".updated_at >= ${table2.date_filter}',
                    tablesReferences: ['table2'],
                    hidden: false,
                },
            },
            metrics: {
                metric1: {
                    ...
                    compiledSql: 'SUM("table2".value_column)',
                    table: 'table2',
                    tableLabel: 'Table 2',
                    fieldType: FieldType.METRIC,
                    tablesReferences: ['table2'],
    ...
    joinedTables: [
        {
            table: 'table2',
            sqlOn: '"table1".id = "table2".table1_id',
            compiledSqlOn: '"table1".id = "table2".table1_id',
            type: 'left',
        },
    ],
};

export const METRIC_QUERY_WITH_VARIABLES: CompiledMetricQuery = {
    dimensions: ['table1_dim1', 'table2_dim1'],
    metrics: ['table1_metric1', 'table2_metric1'],
    filters: {
        dimensions: { id: 'dimensions', and: [] },
        metrics: { id: 'metrics', and: [] },
        tableCalculations: { id: 'tableCalculations', and: [] },
    },
    sorts: [{ fieldId: 'table1_metric1', descending: true }],
    limit: 10,
    tableCalculations: [],
    ...
    compiledAdditionalMetrics: [],
    compiledCustomDimensions: [],
    exploreName: 'explore_with_variables',
};

export const METRIC_QUERY_WITH_VARIABLES_SQL = `SELECT
  "table1".dim1 WHERE "table1".created_at >= ('2023-01-01') AS "table1_dim1",
  "table2".dim1 WHERE "table2".updated_at >= ('2023-12-31') AS "table2_dim1",
  SUM("table1".number_column) AS "table1_metric1",
  SUM("table2".value_column) AS "table2_metric1"
FROM "db"."schema"."table1" AS "table1"
LEFT OUTER JOIN "db"."schema"."table2" AS "table2"
