        ...
        table1: {
            ...
            metrics: {
                ...
                metric2: {
                    ...
                    name: 'metric2',
                    label: 'metric2',
                    sql: '${TABLE}.count_column',
                    compiledSql: 'COUNT("table1".count_column)',
                    tablesReferences: ['table1'],
                    isAutoGenerated: false,
                    hidden: false,
                },
                metric3: {
                    ...
                    name: 'metric3',
                    label: 'metric3',
                    sql: '${TABLE}.number_column / ${TABLE}.count_column',
                    compiledSql:
                        'MAX("table1".number_column) / COUNT("table1".count_column)',
                    tablesReferences: ['table1'],
                    isAutoGenerated: false,
                    hidden: false,
                },
...
export const METRIC_QUERY_NESTED_METRIC: CompiledMetricQuery = {
    dimensions: ['table1_dim1'],
    metrics: ['table1_metric3'],
    filters: {},
    sorts: [],
    limit: 5,
    tableCalculations: [],
...
export const METRIC_QUERY_NESTED_METRIC_SQL = `SELECT
  "table1".dim1 AS "table1_dim1",
  MAX("table1".number_column) / COUNT("table1".count_column) AS "table1_metric3"
FROM "db"."schema"."table1" AS "table1"
