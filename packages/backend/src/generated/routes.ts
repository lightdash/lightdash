...
const models: TsoaRoute.Models = {
    ...
    'Pick_Metric.formatOptions_': {
        ...
        type: {
            dataType: 'nestedObjectLiteral',
            nestedProperties: { formatOptions: { ref: 'CustomFormat' } },
            validators: {},
        },
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    app.get(
        ...
        async function CatalogController_getMetricsWithTimeDimensions(
            ...
            try {
                ...
                const promise = controller.getMetricsWithTimeDimensions.apply(
                    controller,
                    validatedArgs as any,
                );
                promiseHandler(controller, promise, response, 200, next);
    ...
    app.get(
        ...
        async function CatalogController_getMetricsTree(
            ...
            try {
                ...
                const promise = controller.getMetricsTree.apply(
                    controller,
                    validatedArgs as any,
                );
                promiseHandler(controller, promise, response, 200, next);
    ...
    app.post(
        ...
        async function CatalogController_createMetricsTreeEdge(
            ...
            try {
                ...
                const promise = controller.createMetricsTreeEdge.apply(
                    controller,
                    validatedArgs as any,
                );
                promiseHandler(controller, promise, response, 200, next);
    ...
    app.delete(
        ...
        async function CatalogController_deleteMetricsTreeEdge(
            ...
            try {
                ...
                const promise = controller.deleteMetricsTreeEdge.apply(
                    controller,
                    validatedArgs as any,
                );
                promiseHandler(controller, promise, response, 200, next);
    ...
    app.get(
        ...
        async function CatalogController_hasMetricsInCatalog(
            ...
            try {
                ...
                const promise = controller.hasMetricsInCatalog.apply(
                    controller,
                    validatedArgs as any,
                );
                promiseHandler(controller, promise, response, 200, next);
    ...
    app.post(
        ...
        async function SpotlightController_postSpotlightTableConfig(
            ...
            try {
                ...
                const promise = controller.postSpotlightTableConfig.apply(
                    controller,
                    validatedArgs as any,
                );
                promiseHandler(controller, promise, response, 201, next);
    ...
    app.get(
        ...
        async function SpotlightController_getSpotlightTableConfig(
            ...
            try {
                ...
                const promise = controller.getSpotlightTableConfig.apply(
                    controller,
                    validatedArgs as any,
                );
                promiseHandler(controller, promise, response, 200, next);
    ...
    app.delete(
        ...
        async function SpotlightController_resetSpotlightTableConfig(
            ...
            try {
                ...
                const promise = controller.resetSpotlightTableConfig.apply(
                    controller,
                    validatedArgs as any,
                );
                promiseHandler(controller, promise, response, 200, next);
    ...
    app.get(
        ...
        async function FeatureFlagController_getFeatureFlag(
            ...
            try {
                ...
                const promise = controller.getFeatureFlag.apply(
                    controller,
                    validatedArgs as any,
                );
                promiseHandler(controller, promise, response, 200, next);
