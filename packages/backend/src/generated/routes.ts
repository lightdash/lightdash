...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
    app.get(
        '/api/v1/projects/:projectUuid/dataCatalog/recharts-svg-poc',
        ...fetchMiddlewares<RequestHandler>(CatalogController),
        ...fetchMiddlewares<RequestHandler>(
            CatalogController.prototype.getRechartsSvgPOC,
        ),

        async function CatalogController_getRechartsSvgPOC(
            request: any,
            response: any,
            next: any,
        ) {
            ...
            try {
                ...
                const promise = controller.getRechartsSvgPOC.apply(
                    controller,
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get(
        '/api/v1/projects/:projectUuid/dataCatalog/recharts-render-poc',
        ...fetchMiddlewares<RequestHandler>(CatalogController),
        ...fetchMiddlewares<RequestHandler>(
            CatalogController.prototype.getRechartsRenderPoc,
        ),

        async function CatalogController_getRechartsRenderPoc(
            request: any,
            response: any,
            next: any,
        ) {
            ...
            try {
                ...
                const promise = controller.getRechartsRenderPoc.apply(
                    controller,
                    validatedArgs as any,
                );
                promiseHandler(controller, promise, response, 200, next);
