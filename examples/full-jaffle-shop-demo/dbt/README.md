...
### Install Lightdash:
Take advantage of our installation script to easily run Lightdash locally. Check the [self-hosting docs](https://docs.lightdash.com/self-host/self-host-lightdash) for more details.
```bash
