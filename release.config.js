...
module.exports = {
    ...
    plugins: [
        ...
        [
            ...
            {
                prepareCmd:
                    'npx tsx scripts/gen-release-safety.ts --version ${nextRelease.version} --previous-version "${lastRelease.version}" --last-tag "${lastRelease.gitTag}" --out release-safety.json --rest-from-tag --ai-review',
            },
        ],
