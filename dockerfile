...
# -----------------------------
# Build versioned Perl packages in an isolated stage.
...
COPY docker/security/perl-bookworm /tmp/perl-backport
RUN bash /tmp/perl-backport/build.sh "${PERL_VERSION}" "${PERL_BACKPORT_VERSION}"
