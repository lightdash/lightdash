...
We create your first project using your local dbt `profiles.yml` file. So, you might want to update your connection settings to point to your production environment. You can read about [how to update your connection settings here](/get-started/setup-lightdash/connect-project.mdx).  