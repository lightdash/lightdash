...
**Don't have NodeJS/NPM installed in your system?** [Head out to NodeJS's download page](https://nodejs.org/en/download/)
before proceeding with installing the Lightdash CLI tool. Alternatively, you can [install NodeJS/NPM via package manager](https://nodejs.org/en/download/package-manager/).
