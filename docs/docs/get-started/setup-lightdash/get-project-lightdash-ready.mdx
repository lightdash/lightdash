...
This doc is for someone who's just getting started with Lightdash and **has an empty project that they want to setup**. 

If you have an existing Lightdash project with some Tables already in it, we'd suggest checking out [Adding dimensions to Lightdash](/guides/how-to-create-dimensions), [Adding and managing Tables in Lightdash](/guides/adding-tables-to-lightdash), or [Adding metrics to Lightdash](/guides/how-to-create-metrics).
...
If you're working with a version controlled project, you'll just want to make sure to merge your changes into production (e.g. `main` or `master`) before you connect your Lightdash project. If you're working with a local project that isn't version controlled, you don't need to worry about syncing your changes.

Once you've got the model .yml files where you want 'em, you're ready to move onto the next step of connecting your project: so, open up Lightdash and head to the project connection page!