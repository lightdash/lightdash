...
## Step 3: Create your project using `lightdash deploy --create`

Now, your dbt project is Lightdash-ready: so, just run `lightdash deploy --create` and you should get a link to open up Lightdash and start exploring your data!
