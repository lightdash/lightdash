...
**Don't have NodeJS installed in your system?** [Head out to NodeJS's download page](https://nodejs.org/en/download/)
before proceeding with installing the Lightdash CLI tool.
