...
**New to dbt?** We recommend [starting with dbt Core](https://docs.getdbt.com/guides/manual-install?step=1) if you're comfortable with local development (CLI, code editor, git). If you prefer to do everything in a web app you can [use dbt Cloud](https://docs.getdbt.com/docs/get-started-dbt#dbt-cloud).
...
<details>
  ...
  Make sure that you're in your dbt project folder before you try doing `lightdash
