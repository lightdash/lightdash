...
To update an existing connection, head to `1. Settings` --> `2. Project management` --> then the `3. Settings` button beside your project (see steps 1-3 in the image below).

To create a new project connection, head to `1. Settings` --> `2. Project management` --> `4. Create new` (see steps 1, 2 & 4 in the image below).
