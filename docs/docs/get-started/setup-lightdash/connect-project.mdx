...
If you're a Lightdash Cloud user setting up your first project, this is where you'll need to open up the registration link that we sent to you.
...
If you're looking to create a new project in an organization with an existing project, you'll want to click on `Settings` --> `Project management` --> `Create new`.
