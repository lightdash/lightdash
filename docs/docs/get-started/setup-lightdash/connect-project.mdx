...
<img src={FineGrainedRepo} width="500" height="375" style={{display: "block", margin: "0 auto 20px auto"}}/>

4. On repository permissions, select `Contents` 

<img src={FineGrainedPermissions} width="800" height="91" style={{display: "block", margin: "0 auto 20px auto"}}/>

5. Click `Generate token` and copy the token. 

6. On create project page, add your [gihtub_username]:[token] into `Personal access token` field, like this: 

<img src={FineGrainedProject} width="300" height="327" style={{display: "block", margin: "0 auto 20px auto"}}/>
