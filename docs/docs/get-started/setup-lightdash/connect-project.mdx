...
If it's your first time opening Lightdash, you'll be prompted to create a new user then, you should be prompted to connect a project (if you're joining an organization without a project).
