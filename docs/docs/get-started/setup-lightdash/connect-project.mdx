...
We don't support connecting Lightdash to [dbt Cloud managed repositories](https://docs.getdbt.com/docs/dbt-cloud/cloud-configuring-dbt-cloud/cloud-using-a-managed-repository). If you'd like to use Lightdash, you'll need to have a remote repository for your dbt project in one of the services above.
...
This is the number of multiple concurrent queries Lightdash will run against your BigQuery warehouse. Use a higher 
...
This is the number of multiple concurrent queries Lightdash will run against your Postgres warehouse. Use a higher 
number if you have a larger warehouse. A larger number of threads will increase performance for many users Lightdash 
at the same time.
...
This is the number of multiple concurrent queries Lightdash will run against your Redshift warehouse. Use a higher 
number if you have a larger warehouse. A larger number of threads will increase performance for many users Lightdash 
at the same time.
