...
import FineGrainedProject from './assets/fine-grained-project.png';
...
If you need to add our IP address to your database's allow-list, check what IP addresses we use [here](../../references/ip_addresses)
...
You can read more about on the [Github docs](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/creating-a-personal-access-token#creating-a-fine-grained-personal-access-token).
...
2. Add the name, expiration, description and owner (we'll need his username later)
3. Add repository access, you might want to give access only to your `dbt` repository

<img src={FineGrainedRepo} width="1097" height="647" style={{display: "block", margin: "0 auto 20px auto"}}/>

4. On repository permissions, select `Contents` 

<img src={FineGrainedPermissions} width="1097" height="150" style={{display: "block", margin: "0 auto 20px auto"}}/>

5. Click `Generate token` and copy the token. 

6. On create project page, add your [gihtub_username]:[token] into `Personal access token` field, like this: 

<img src={FineGrainedProject} width="1097" height="647" style={{display: "block", margin: "0 auto 20px auto"}}/>
