...
If you're using dbt Cloud, you can just follow the guides for connecting the repository type of your project:
...
This is used by Lightdash to access your repo.
See the [instructions for creating a http access token here](https://confluence.atlassian.com/bitbucketserver/http-access-tokens-939515499.html).
