...
[![tutorial create metrics](./assets/tutorial_adding_metrics.png)]({https://www.loom.com/share/6b8d3d5ccc644fa8bf68ffb754cbb783} "Tutorial - Create your first dimensions and metrics")
