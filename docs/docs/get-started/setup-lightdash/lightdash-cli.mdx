...
Your Lightdash CLI version should match the version of Lightdash you see in the UI. You can check the version of 
your CLI by running:
...
**Note that Google SSO login is not supported on the CLI yet**
