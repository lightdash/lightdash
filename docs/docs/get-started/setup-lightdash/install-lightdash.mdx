...
3. [Deploy **Lightdash to Restack on your own AWS infastructure**](#deploy-to-restack) to setup Lightdash in production on kubernetes.
...
To deploy Lightdash with Restack:
