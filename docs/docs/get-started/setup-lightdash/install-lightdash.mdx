---
sidebar_position: 2
sidebar_label: (Optional) Self-host Lightdash
---

# Self-host Lightdash

_Don't want to worry about self-hosting? [Sign up for Lightdash Cloud](#getting-setup-on-lightdash-cloud) for a 
fully-managed Lightdash instance._
