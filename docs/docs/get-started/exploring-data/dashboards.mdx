...
<img src={MoveChartToSpace} width="524" height="477" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={DashboardClickEditButton} width="500" height="622" style={{display: "block", margin: "0 auto 20px auto"}}/>

Click on the `Add filter` button to add a new filter to your dashboard by selecting a field and a value to filter by.

<img src={AddNewFilter} width="500" height="622" style={{display: "block", margin: "0 auto 20px auto"}}/>

Select a value to filter by and hit `Apply`. You can add as many filters as you like.

<img src={AddNewFilterAndSetValue} width="500" height="622" style={{display: "block", margin: "0 auto 20px auto"}}/>

Now that you've added a filter, you can see the filter applied to your dashboard.

<img src={DashboardNewFilterApplied} width="1119" height="622" style={{display: "block", margin: "0 auto 20px auto"}}/>
