...
Groups are only available on Lightdash Cloud Pro, Enterprise plans, and Self-Hosted instances. For more information on our plans, visit our [pricing page](https://www.lightdash.com/pricing).
