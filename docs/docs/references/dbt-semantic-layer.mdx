...
The dbt Semantic Layer integration is only available to [Lightdash Cloud users](https://www.lightdash.com/pricing). To have the dbt Semantic Layer integration activated on your account, please contact the Lightdash team. 
...
You can save charts from your dbt Semantic Layer queries and build dashboards with these charts in Lightdash. 
