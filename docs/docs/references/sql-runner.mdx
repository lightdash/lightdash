...
2. [Create a **Virtual View** so your query becomes a reusable table in Lightdash](#virtual-views)
...
Virtual Views allow other users to reuse your custom SQL queries in Lightdash. They get listed in your `Tables` in Lightdash and can be used like the tables in Lightdash that come from your dbt project.
