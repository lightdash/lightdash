...
import HundredStackedBarChart from './assets/hundred-stacked-bar-chart.png';
...
import FunnelChart from './assets/funnel-chart.png';
import FunnelChartGeneral from './assets/funnel-chart-general.png';
