...
Users who have `full access` to a space can adjust other users' space permissions, except for admins.

They can restrict a user’s inherited project permissions in a space (e.g. you can make project editors into `can view` in a space). They can also give `interactive viewers` permissions to `can edit` in a space so they can save content to a space (but nowhere else in the project). 

| Action                                                        | Full Access  | Can Edit | Can View |
| :------------------------------------------------------------ | :----------: | :------: | :------: |
| Edit a Space's access (from Public to Restricted)             |      ✅      |     ❌    |    ❌    |
| Change the permissions of a user that has access to the space |      ✅      |     ❌    |    ❌    |
...
| Edit content in the Space (charts, dashboards)                |      ✅      |     ✅    |    ❌    |
