...
| [format](#format)                           | No       | string                                                                                                                                            | This option will format the output value on the result table and CSV export. Currently supports one of the following: `['km', 'mi', 'usd', 'gbp', 'eur',(... and more currencies), 'percent', 'id']`                                                                                 |
...
Additional dimensions let you define multiple dimensions off of a single column. This is useful when handling JSONB
