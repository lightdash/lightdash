...
| [compact](#compact)               | No       | string                                                                                                                                            | This option will compact the number value on the result table and CSV export. Currently supports one of the following: `['thousands', 'millions', 'billions', 'trillions']`                                                                                |
...
| Value     | Alias value        | Example output |
|-----------|--------------------|----------------|
