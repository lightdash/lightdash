...
### Here are the filter types we support

|       Type                  | Example (in English)                           | Example (as code)     |
|:---------------------------:| ---------------------------------------------- | --------------------- |
| is equal to                 | User name is equal to katie                    | `user_name: katie`    |
| is not equal to             | User name is not equal to katie                | `user_name: !katie`   |
