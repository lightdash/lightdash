...
| groups                                              | No       | string                         | string[]                                                                                                                                                                                                                                             | If you set this property, the metric will be grouped in the sidebar with other metrics with the same group label. |
...
| is greater than (date)      | Date is after 2024-05-01                       | `date: "> '2024-05-01'"` |
