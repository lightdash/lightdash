...
### Creating a custom metric from a dimension
...
### Setting filters to your custom metric

These filters are based on the dimensions set in your project, allowing for more precise metrics.
The ability to add filters is now available when you're creating a new custom metric or editing an existing one.

You can add filters to your custom metric in 2 ways: 
1. By creating a custom metric: 
<img src={CustomMetricAddFilterWhenCreating} width="700" height="200" style={{display: "block", margin: "0 auto 20px auto"}}/>

2. By editing an existing custom metric:
