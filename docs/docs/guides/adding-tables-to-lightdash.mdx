...
If you haven't installed the Lightdash CLI yet, then [follow this guide to installing and setting it up](/guides/how-to-install-the-lightdash-cli.mdx), then come back to these docs once you're ready!
...
Now, your Table is Lightdash-ready: so, open up Lightdash and click `refresh dbt` and your Table should pop up in your project.
...
<img src={TablesConfiguration} width="1233" height="397" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={PickTables} width="352" height="205" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
You can still access + explore all of the Tables from your dbt project (with .yml files), even if you've filtered them from appearing in the sidebar. Just click on the `Show hidden tables` toggle in the Tables sidebar. 

<img src={ShowHiddenTables} width="276" height="136" style={{display: "block", margin: "0 auto 20px auto"}}/>
