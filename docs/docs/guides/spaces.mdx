...
**Eveyone who has access to the project your Space is in gets access to a Public Space.**
...
In Public spaces (just like in restricted spaces), users who have `Full Access` to the space can change other users' space permissions. Users cannot be removed from Public Spaces (i.e. they can't be made to have `no access`). To make a user have `no access` to a space, you must change the space from Public to Restricted.