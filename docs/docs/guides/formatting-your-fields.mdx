...
You can group related metrics and dimensions together using the model meta `groups` block in combination with the `group` property in your .yaml files.
