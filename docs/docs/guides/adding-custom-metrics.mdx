...
# Adding custom metrics in your Explore

## 🪄 Adding custom metrics in your Explore 

The fields that you see in your `dimensions` and `metrics` are created by the people maintaining your Lightdash project. 

But, if there's something missing from this list of metrics, you can use `custom metrics` to add some on-the-fly calculations to your Explore. 
...
Like we mentioned above, custom metrics are on-the-fly calculations in your Explore. They're a bit different to the regular metrics you define in your YAML, but some things are the same. 
...
- **You can't persist your custom metrics in the Explore.** If you add some custom metrics in your Explore, then these custom metrics won't pop up for the next person that opens the Explore. 
- **But, you can use custom metrics in a saved chart.** If you've added custom metrics to your saved chart, and someone else opens the saved chart, they'll see your custom metrics. But, if they open a new, fresh Explore, your custom metrics won't appear there. 
...
<img src={ThreeDotOption} width="1064" height="651" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={DeleteCustomMetric} width="738" height="192" style={{display: "block", margin: "0 auto 20px auto"}}/>

---

## 👩‍💻 Adding metrics in your dbt project

If you want to add more permanent metrics to your Lightdash project that are always in the Explore when anyone opens it up, then you'll want to add metrics to your dbt project. You can learn all about adding metrics in your dbt project [in this tutorial](https://docs.lightdash.com/get-started/setup-lightdash/add-metrics). 
