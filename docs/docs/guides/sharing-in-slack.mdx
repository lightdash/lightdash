...
> If you are running a self-hosted Lightdash server, please check [Add Slack integration on self-hosting](https://docs.lightdash.com/guides/sharing-in-slack) first
