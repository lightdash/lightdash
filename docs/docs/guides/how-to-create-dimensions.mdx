...
## Step 1. Create a dimension in Lightdash using `lightdash dbt run -s my_model`
...
## Step 2: Preview your changes using `lightdash preview`
...
## Step 3: Configure your dimension (optional)
...
## Step 4: Once you're happy with your changes, you can deploy them to production
