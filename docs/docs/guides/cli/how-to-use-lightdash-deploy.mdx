...
<details>
  ...
  Step 1: create a secret called `GOOGLE_CREDENTIALS`. 
  
  This will contain the service account credentials (the JSON file) that you'll use below. It should look something like this:
