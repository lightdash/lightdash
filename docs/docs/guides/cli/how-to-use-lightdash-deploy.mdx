...
<details>
    ...
    outputs:
      dev:
        ...
        keyfile_json:
          ...
          project_id: xxx
          private_key_id: xxx
          private_key: "xxx" # Make sure to copy + paste your private key including the quotes around it (i.e. copy "my-private-key" NOT copy my-private-key). 
          client_email: xxx
          client_id: xxx
          auth_uri: xxx
          token_uri: xxx
  ...
  Note: if you're getting a "Could not deserialize key data." error, it's likely because your private_key has had some characters changed while it was copy-pasted. To fix this, try copy-pasting your private key including the quotes around it, like this: "my-private-key" instead of copy-pasting the value without quotes, like this: my-private-key. 
