...
---
sidebar_label: How install the Lightdash CLI
---
...
<details>
  ...
  First, you'll need to create a new personal access token in the UI by going to Settings > Personal Access Tokens. **Note:** you can't use an existing personal access token! You have to create a new one just for yourself.
