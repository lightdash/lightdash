...
If you are using a continuous integration job in dbt cloud, you can use the schema (`dbt_cloud_pr_<job_id>_<pr_id>`) that is created by dbt cloud for your preview project.
