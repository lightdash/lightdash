...
## How to use the developer credentials for the preview project
...
Update your profiles.yml to have 1 target per developer. The target name should be their GitHub username.
