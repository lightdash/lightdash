...
I have a chart with the sales stats (a metric) per partner, per month. As you can seed, there's a high spike in sales for one of the partners in the month of May. I want to understand why this spike happened.
