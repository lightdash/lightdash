...
<img src={UnderlyingChart} width="862" height="470" style={{display: "block", margin: "0 auto 20px auto"}}/>

<img src={UnderlyingResults} width="973" height="752" style={{display: "block", margin: "0 auto 20px auto"}}/>
