...
When viewing a dashboard, you can also change the date granularity (e.g. to Week, Year) of the **charts with date dimensions in your dashboard** by clicking on the button `Date Zoom`. With this, you're able to quickly date-drill into your data without having to edit the chart.
