...
<figure>
  ...
  />
  <figcaption>You'll notice there's a `?filters=` key in the URL. Everything after that is a JSON object that has been URL encoded. If you want to see the JSON you can find a URL decoder online to reformat it.</figcaption>
</figure>
