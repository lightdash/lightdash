...
<img src={AddReferenceLine} width="286" height="315" style={{display: "block", margin: "0 auto 20px auto"}}/>

To add a reference line, you just need to tick the `add reference line` box, then configure your reference line in the drop-down. 

You can:
- select a field you want to apply your reference line to
- select the value you want to set your line at

<img src={ReferenceLineConfig} width="286" height="315" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
Reference lines can only be applied to numeric fields in your chart. 

For your legend, you can:
