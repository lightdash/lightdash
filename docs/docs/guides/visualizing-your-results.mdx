...
To use color ranges for your rules, select `color range` as the type. You can then set the values and colors you'd like to use for your minimum and maximum values in your table. By defult, these color ranges use a set of 5 colors mapped across your min and max colors selected.
