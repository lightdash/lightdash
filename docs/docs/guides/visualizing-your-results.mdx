...
<img src={AddReferenceLine} width="658" height="246" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={ReferenceLineConfig} width="286" height="278" style={{display: "block", margin: "0 auto 20px auto"}}/>
