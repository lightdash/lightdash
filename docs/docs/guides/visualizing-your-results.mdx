...
If your total values are different to what you'd expect, check out our [FAQs page](../help-and-contact/faqs.mdx#why-dont-my-totals-match-whats-in-my-table) on "Why don't my totals match what's in my table?"
