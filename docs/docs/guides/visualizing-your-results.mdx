...
To pivot by a column in your table, just add the column you want to pivot by to the `group` option in the config panel. This will rotate the rows from this dimension into columns.
