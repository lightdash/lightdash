...
<img src={ChartTypes} width="814" height="358" style={{display: "block", margin: "0 auto 20px auto"}}/>

You can also adjust all of the configuration settings for your chart type by clicking on the `configure` button:

<img src={ConfigButton} width="807" height="446" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={BigValue} width="280" height="217" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={TableChart} width="593" height="201" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={ColumnsRowsMetricsExample} width="1558" height="410" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={PivotedTable} width="1076" height="596" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={MetricsAsRows} width="1120" height="893" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={LockedColumn} width="419" height="749" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={ConditionalFormatting} width="513" height="169" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={ConditionalFormattingRule} width="283" height="572" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
To use color ranges for your rules, select `color range` as the type. You can then set the values and colors you'd like to use for your minimum and maximum values in your table. By defult, the color range will use a set of 5 colors mapped across the min and max colors selected.

<img src={ColorRangesExample} width="676" height="431" style={{display: "block", margin: "0 auto 20px auto"}}/>

### Pie chart

<img src={PieChart} width="561" height="309" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={PieChartLayout} width="266" height="210" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={PieChartSeries} width="262" height="273" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={PieChartDisplay} width="258" height="66" style={{display: "block", margin: "0 auto 20px auto"}}/>

You can choose to show or hide the legend for your pie chart in the `display` tab. 

### Bar chart

<img src={BarChart} width="612" height="266" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={StackedBarChart} width="623" height="296" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={AddReferenceLine} width="742" height="426" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={ReferenceLineConfig} width="293" height="470" style={{display: "block", margin: "0 auto 20px auto"}}/>
