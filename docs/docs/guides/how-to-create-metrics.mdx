...
The more permanent metrics to your Lightdash project that are always in the Table when anyone opens it up, are defined in your dbt project .yml files along with your dimensions and dbt model properties.
...
<img src={ThreeDotOption} width="1546" height="942" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
## 🔄 Syncing metrics in Lightdash

Once you've added your metrics, you'll want to re-sync your Lightdash project by clicking on `refresh dbt`.
