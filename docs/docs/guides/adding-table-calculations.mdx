...
Once you've created a new table calculation, you need to hit `run query` to see the values in your results table. And voilà!
...
[Just gimme the code! 👾](#👀-heres-the-sql-you-can-copy-paste-to-calculate-a-running-total)
...
[Just gimme the code! 👾](#👀-heres-the-sql-you-can-copy-paste-to-calculate-the-percent-of-a-total-column)
...
#### 👀 Here's the SQL you can copy-paste to calculate the percent of a total column
