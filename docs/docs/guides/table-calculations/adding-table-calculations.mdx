...
#### 5. Once you've saved your new table calculation, hit `run query` to see the results
...
#### 6. To delete or edit your table calculation, just click on the gear icon by the field name
