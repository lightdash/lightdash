import RunningTotal from './assets/rolling-window.jpg';

# Rolling window

Rolling windows, or lookbacks, calculate metrics using the current row combined with N previous rows. This can be useful for smoothing out volatile time series data to better understand long term trends.

[Just gimme the code! 👾](#heres-the-sql-you-can-copy-paste-to-calculate-rolling-windows)
...
- `column_I_want_to_order_by` is the column you want to order your running total over
