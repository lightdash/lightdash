...
You can dismiss errors from validation by clicking on the "x" button that appears after hovering the row on the validation table. 

<img src={DismissErrors} width="1125" height="568" style={{display: "block", margin: "0 auto 20px auto"}}/>

Dismissed validations are applied to everyone, and they will reappear again if you run validations again and the issue hasn't been fixed yet. 