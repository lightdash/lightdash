...
Broken content is not useful content. So, we've built tools in Lightdash to help you validate your projects so you can keep your content useful and we'll notify you when it isn't.

In Lightdash, users with [admin or developer roles](../references/roles) can access the content validation dashboard from within a project's settings. This dashboard gives you an overview of all of the broken content in your project and detailed information about what is causing the errors.
