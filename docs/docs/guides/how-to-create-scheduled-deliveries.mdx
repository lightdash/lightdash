...
YOu can send scheduled deliveries to private channels, to do this, simply type the name of the slack channel on the 
autocomplete input text. Then click on the name to confirm and save the scheduled delivery. 
