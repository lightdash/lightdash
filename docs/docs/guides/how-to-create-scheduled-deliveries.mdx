...
If you are running Lightdash on self-host, make sure you have the [headless browser](https://docs.lightdash.com/guides/enable-headless-browser-selfhost) to generate images. 
