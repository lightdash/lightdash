...
If you update the project's default time zone, then scheduled deliveries where the time zone hasn't been customized will automatically be updated to use the new default time zone. 