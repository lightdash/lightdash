...
<img src={ThreeDotMenu} width="752" height="222" style={{display: "block", margin: "0 auto 20px auto"}}/>
...
<img src={ConfigureNewDelivery} width="526" height="598" style={{display: "block", margin: "0 auto 20px auto"}}/>
