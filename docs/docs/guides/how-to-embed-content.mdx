...
Lightdash allow you to embed some of your dashboards using expirable URLs and tokens (embed URLs from now on). Embedding is only available with a commercial Lightdash license, [get in touch](https://lightdash.typeform.com/to/BujU5wg5) to have this enabled in your account.
