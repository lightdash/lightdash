...
import EmbedAddDashboards from './assets/embed-add-dashboards.png';
...
First you need to generate a secret per organization. 
...
<img src={EmbedAddDashboards} width="668" height="466" style={{display: "block", margin: "0 auto 20px auto"}}/>
