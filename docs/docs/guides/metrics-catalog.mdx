...
#### 3. Once you have set a default time dimension on a table, compile your project.
...
(See [how to compile your project](/references/dbt-projects.mdx) for more information on getting your project ready for catalog exploration)

#### 4. Go to the metrics catalog and Explore a metric from the table/model you have set a default time dimension on.
