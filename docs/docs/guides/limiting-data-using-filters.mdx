...
4. If you want, you can adjust which tiles the filter is applied to by clicking on the `Tiles` tab.
...
5. Click `apply`, and your filters will pop up on the top of your dashboard.

<img src={NewFiltersDashboard} width="543" height="188" style={{display: "block", margin: "0 auto 20px auto"}}/>

6. Once you have all of the filters you want, just hit `save` to save your filter settings.

<img src={SaveDashboard} width="459" height="171" style={{display: "block", margin: "0 auto 20px auto"}}/>

7. Now, whenever someone opens the dashboard, they'll see your saved filters applied!
