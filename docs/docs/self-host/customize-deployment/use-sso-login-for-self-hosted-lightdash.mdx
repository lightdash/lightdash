...
Okta users will automatically be assigned to the same groups in Lightdash as they are in Okta. If you wish to disable this functionality, you can set the following environment variable:
