...
In this guide we will show you how you can [upload to Google Sheets in scheduled deliveries](https://docs.lightdash.com/guides/how-to-create-syncs) and
...
To create a Google Drive picker API you need to add a new API key in [APIs and services in Google Cloud](https://console.cloud.google.com/apis/credentials)
