...
This file provides guidance to Claude Code (claude.ai/code) when working with code in this repository. Per-area notes also live in nested `AGENTS.md` files under `packages/`.
