...
- After any frontend edit, run `pnpm -F frontend fix-format` (`oxfmt ./src`) before committing. Do not skip this or rely on lint-staged. Other packages have the same script (`pnpm -F <package> fix-format`).
