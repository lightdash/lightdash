 ...
 *   SMOKE_EMAIL / SMOKE_PASSWORD   (default the seeded viewer)
...
const EMAIL = process.env.SMOKE_EMAIL ?? 'demo3@lightdash.com';
const PASSWORD = process.env.SMOKE_PASSWORD ?? 'demo_password!';
