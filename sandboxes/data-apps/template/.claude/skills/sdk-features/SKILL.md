...
| "Conditional formatting", highlight values over a threshold (viz only) | `viz-conditional-formatting` | declaration + app code — see the reusable-visualization skill |
